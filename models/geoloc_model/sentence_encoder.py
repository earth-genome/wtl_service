...
cached locally and input as module_path or by setting environment variable 
TFHUB_CACHE_DIR. If TFHUB_CACHE_DIR is set, on a call to
...
class TFSentenceEncoder(object):
    ...
    """
    def __init__(self, session, module_path=None, module_url=MODULE_URL,
                 pad_to=None):
